...
//    }
//
//    private void check_payed_month() {
//        (new Thread(() -> {
//            try {
...
//    }
//
//    private void goNext(String monthString) {
//        SharedPreferences lock = getSharedPreferences("access", MODE_PRIVATE);
//        String currentMonth = lock.getString("payed_month", "99");
//        if (!currentMonth.equals(monthString)) {
//            startActivity(new Intent(TeleDetailActivity.this, Logo_Activity.class));
//            finishAffinity();
//        }
//
//    }
...
//            if (String.valueOf(list.getItemAtPosition(i)).equals(cater)) {
