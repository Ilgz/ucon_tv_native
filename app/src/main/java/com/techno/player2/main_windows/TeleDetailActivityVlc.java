...
public class TeleDetailActivityVlc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tele_detail_vlc);
        handler = new Handler();
        r = this::showInActivityDialog;
        startHandler();
        channelsDataShared = getSharedPreferences(getString(R.string.k_shared), MODE_PRIVATE);
        handler2 = new Handler();
        cater = getIntent().getStringExtra("cater");
        initi();
        createPlayer();
        new Handler(Looper.getMainLooper()).postDelayed(this::fullOff, 500);
        if (cater != null) {
            switch (cater) {
                case "efir":
                    allNamesJson(7);
    ...
    private void fullOn() {
        ...
        list.setAlpha(0);
        vlcVideoLayout.setLayoutParams(new ConstraintLayout.LayoutParams(ConstraintLayout.LayoutParams.MATCH_PARENT, ConstraintLayout.LayoutParams.MATCH_PARENT));
    ...
    private void fullOff() {
        ...
        vlcVideoLayout.setLayoutParams(new ConstraintLayout.LayoutParams(ConstraintLayout.LayoutParams.MATCH_CONSTRAINT, ConstraintLayout.LayoutParams.MATCH_CONSTRAINT));
    ...
    private void createPlayer() {
        ...
        vlcVideoLayout = findViewById(R.id.player);
...
//            });
    ...
    private void newsClick(String category) {
        ...
        if (category.equals("News")) {
            efirAdapter = new MyAdapter(TeleDetailActivityVlc.this, titlesNews);
        } else if (category.equals("Film")) {
            efirAdapter = new MyAdapter(TeleDetailActivityVlc.this, titlesCinema);
        } else if (category.equals("Sport")) {
            efirAdapter = new MyAdapter(TeleDetailActivityVlc.this, titlesSport);
        } else if (category.equals("Music")) {
            efirAdapter = new MyAdapter(TeleDetailActivityVlc.this, titlesMusical);
        } else if (category.equals("Child")) {
            efirAdapter = new MyAdapter(TeleDetailActivityVlc.this, titlesKinder);
        } else if (category.equals("Cognitive")) {
            efirAdapter = new MyAdapter(TeleDetailActivityVlc.this, titlesPoznavat);
        } else if (category.equals("International")) {
            efirAdapter = new MyAdapter(TeleDetailActivityVlc.this, titlesInternational);
        } else {
            efirAdapter = new MyAdapter(TeleDetailActivityVlc.this, titlesAlll);
        }
    ...
    private JSONArray JresponseBoil(String catName) {
        ...
        System.out.println(catName + " " + dream);
        JSONArray def = null;
        try {
